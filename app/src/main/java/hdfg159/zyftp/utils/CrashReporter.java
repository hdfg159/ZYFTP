 ...
 * crashReporter.setOnCrashListener(xxx); 清单文件加入权限 <uses-permission
...
public class CrashReporter implements UncaughtExceptionHandler {
	...
	private DateFormat formatterDate = new SimpleDateFormat(
			"yyyy-MM-dd_HH_mm_ss");
	...
	public void uncaughtException ( Thread thread , Throwable ex ) {
		...
		infoString += " APP内部版本号：" + versionCode + "\n";
	...
	private void writeCrashLog ( String info ) {
		...
		File file = new File(mContext.getExternalFilesDir("log") , "crashlog_"
